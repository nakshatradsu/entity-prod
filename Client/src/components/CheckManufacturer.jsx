...
const CheckManufacturer = () => {
    ...
    return (
        <div className="border-2 border-gray-200 dark:border-0 rounded-lg h-96 bg-white dark:bg-[#15161c] dark:text-white" id="detectManufacturer">
            <div className="font-sans p-4 text-black w-full bg-white  justify-center dark:bg-[#15161c] dark:text-white">
